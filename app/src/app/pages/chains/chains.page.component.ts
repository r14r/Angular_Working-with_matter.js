...
import { Body, Bodies, Engine, Render, World, Constraint, Composite, Composites, Vector, Runner, Mouse, MouseConstraint } from 'matter-js';
...
export class ChainsPageComponent implements OnInit {
	...
	demo() {
		...
		this.log(FUNC, 'canvasWidth = ' + canvasWidth);
		this.log(FUNC, 'canvasHeight = ' + canvasHeight);
