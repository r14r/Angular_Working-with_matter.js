...
@Component({
	...
	templateUrl: './collision-filtering.page.component.html',
	styleUrls: ['./collision-filtering.page.component.scss']
})
export class CollisionFilteringPageComponent implements OnInit {
