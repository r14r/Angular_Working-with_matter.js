...
import { Body, Engine, Render, World, Common, Vertices, Bodies, Runner, Composites, Mouse, MouseConstraint } from 'matter-js';

@Component({

	selector: 'app-concave-page',
	templateUrl: './concave.page.component.html',
	styleUrls: ['./concave.page.component.scss']
})
export class ConcavePageComponent implements OnInit {
