...
import { Body, Bodies, Engine, Render, World, Constraint, Common, Composite, Runner, Composites, Mouse, MouseConstraint } from 'matter-js';

@Component({

	selector: 'app-constraints-page',
	templateUrl: './constraints.page.component.html',
	styleUrls: ['./constraints.page.component.scss']
})
export class ConstraintsPageComponent implements OnInit {
