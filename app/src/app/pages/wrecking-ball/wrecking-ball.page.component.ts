...
import { Engine, Events, Bounds, Render, World, Vector, Common, Bodies, Runner, Composites, Mouse, MouseConstraint } from 'matter-js';

@Component({

	selector: 'app-wrecking-ball-page',
	templateUrl: './wrecking-ball.page.component.html',
	styleUrls: ['./wrecking-ball.page.component.scss']
})
export class WreckingBallPageComponent implements OnInit {
